    ...
    <MainLayout>
      ...
      <section className="max-w-3xl mx-auto text-center py-16">
        ...
        <p className="text-xl text-muted-foreground mb-8">
          La plateforme communautaire pour partager et découvrir des connaissances techniques en français.
        </p>
        <div className="prose prose-neutral dark:prose-invert mx-auto text-left space-y-4 text-muted-foreground">
          <p>
            Le Génie est né d&apos;un constat simple : il manque un espace de qualité, en français,
            où les développeurs et professionnels du numérique peuvent partager leurs découvertes,
            leurs retours d&apos;expérience et leurs tutoriels avec une vraie communauté.
          </p>
          <p>
            Notre plateforme permet à chacun de rédiger des articles riches — avec du code,
            des images, des titres structurés — et de les soumettre à la lecture de milliers de
            passionnés. Les lecteurs commentent, likent et contribuent pour faire évoluer les
            publications en temps réel grâce à notre mode collaboratif.
          </p>
          <p>
            Que vous soyez développeur senior souhaitant documenter un pattern avancé, ou étudiant
            partageant vos premières expériences de projet, Le Génie est fait pour vous.
          </p>
        </div>
      </section>
      ...
      <section className="max-w-4xl mx-auto py-12 border-t">
        <h2 className="text-2xl font-bold text-center mb-10">Notre mission</h2>
      ...
      {/* Team */}
      <section className="max-w-4xl mx-auto py-12 border-t">
        <h2 className="text-2xl font-bold text-center mb-10">L&apos;équipe</h2>
