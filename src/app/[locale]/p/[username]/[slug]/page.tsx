 ...
 * Browser URL:  /@username/slug
 * Internal URL: /p/username/slug
 *
 * `username` is cosmetic — not used for lookup.
...
type Props = { params: Promise<{ locale: string; username: string; slug: string }> };
